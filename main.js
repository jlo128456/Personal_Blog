document.addEventListener('DOMContentLoaded', function() {
    ...
    const apiUrl = `http://api.serpstack.com/search?access_key=${accessKey}&query=${query}&engine=google&type=web&device=desktop&location=Australia&google_domain=google.com&gl=us&hl=en&page=1&num=25&output=json`;
